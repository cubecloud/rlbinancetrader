...
if __name__ == '__main__':
    ...
    json_cfg = './save/BinanceEnvCash/MaskablePPO/exp-2909-160702/MaskablePPO_BinanceEnvCash_30000000_cfg.json'
    ...
    with warnings.catch_warnings():
        ...
        rllab.loaded_learn(
            ...
            env_kwargs_update={
                ...
                'stable_cache_data_n': 630,
                'reuse_data_prob': 0.9999,
                'verbose': 0,
            },

            agent_kwargs_update={
                'n_steps': 660 * 630 // agents_n_env // 2,
                'batch_size': 660 * agents_n_env,
                'n_epochs': 10,
                'stats_window_size': 2,
                'ent_coef': 0.01,
                'gamma': 0.99,
                'learning_rate': {'CoSheduller': dict(warmup=1_000_000,
                                                      learning_rate=1e-3,
            ...
            env_wrapper='dummy',
            n_envs=agents_n_env,
            eval_freq=int(100_000 // agents_n_env),
            verbose=0,
        )
