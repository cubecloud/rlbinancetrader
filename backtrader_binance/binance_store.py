...
class BinanceStore(object):
    ...
    def get_all_orders(self, symbol):
        return self.binance.get_all_orders(symbol=symbol)

    @retry
    def get_open_orders(self, symbol):
        return self.binance.get_open_orders(symbol=symbol)

    @retry
    def get_trade_fee(self, symbol):
        return self.binance.get_trade_fee(symbol=symbol)

    @retry
    def get_avg_price(self, symbol):
        return self.binance.get_avg_price(symbol=symbol)
