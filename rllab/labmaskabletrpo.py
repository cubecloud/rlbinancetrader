from typing import Any, ClassVar, Dict, Optional, Tuple, Type, TypeVar, Union, List
...
SelfLabMaskableTRPO = TypeVar("SelfLabMaskableTRPO", bound="LabMaskableTRPO")


class LabMaskableTRPO(OnPolicyAlgorithm):
    """
